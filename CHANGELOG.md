...
- Use Homebrew's current subprocess API for auto-update, formula installs and upgrades,
  and cask upgrades instead of calling the removed command-instance `safe_system` helper.
